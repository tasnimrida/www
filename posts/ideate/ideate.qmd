  ...
  <main class="poster-grid">
    ...
    <div class="final-stack">
      ...
      <section class="section-card large">
        ...
        <p>
          The finished piece holds earrings across the tree branches, with the holes allowing different earring styles to hang at varying heights. Earrings can be arranged for visibility. The rabbit dish adds a second jewelry-storage area for rings and other pieces.
        </p>
      </section>
